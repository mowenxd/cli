...
| 📝 笔记 | `mocli note` | 查看我的墨问笔记、查看指定用户主页笔记、搜索墨问笔记，并支持笔记详情、评论/引用上下文、创建/编辑笔记、标签管理和公开/私有/部分公开规则设置 |
...
| 📝 笔记 | `mo-note` | 查看、搜索、创建、编辑、设置墨问笔记，管理标签，查看笔记详情、评论和引用上下文，适合“最近发表”“某人主页”“关键词搜索”“创建并发布”“改为私有”“给笔记加标签”“介绍这篇笔记”等场景 |
